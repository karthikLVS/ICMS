...
import HistoricalEventImage1 from './images/bihari.jpg';
    ...
    return (
        <div className="Bihar-container">
            ...
            <div className="historical-events">
                ...
                <ul>
                    <li>
                        <h3>Enlightenment in Bodh Gaya</h3>
                        <p>In 537 BC, Siddhartha Gautama attained the state of enlightenment in Bodh Gaya, Bihar. Around the same time, Mahavira who was born in a place called Kundalagrama in the ancient kingdom of Kundalpur in [vaishli] in modern-day Bihar.</p>
