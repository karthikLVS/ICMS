...
import HistoricalEventImage1 from './images/asam.jpg';
    ...
    return (
        <div className="Assam-container">
            ...
            <div className="historical-events">
                ...
                <ul>
                    <li>
                        <h3>The period of Ahom rule</h3>
                        <p>The Ahom dynasty was established by Sukaphaa, a Shan prince of Mong Mao who came to Assam after crossing the Patkai Mountains. It is between 13th and 19th century that several tribal communities also came into the historical forefront of Assam.</p>
