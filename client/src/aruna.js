...
import HistoricalEventImage1 from './images/arunss.jpg';
    ...
    return (
        <div className="ArunachalPradesh-container">
            ...
            <div className="historical-events">
                ...
                <ul>
                    <li>
                        <h3>Sino-Indian War:</h3>
                        <p>During the 1962 Sino-Indian War, Tawang tract of Arunachal Pradesh was captured and temporarily controlled by the Chinese People's Liberation Army. However, China soon declared victory, withdrew back to the McMahon Line and returned Indian prisoners of war in 1963.</p>
