...
app.post('/registration/signup', async function (req, res) {
    try {
        const conn = await client.connect();
        const db = conn.db('MSWD1');
        const users = db.collection('MSWD1');
...
app.post('/home/menu', async function (req, res) {
    try {
        const conn = await client.connect();
        const db = conn.db('MSWD1');
        const menu = db.collection('menu1');
...
app.post('/home/menus', async function (req, res) {
    try {
        const conn = await client.connect();
        const db = conn.db('MSWD1');
        const menus = db.collection('menus1');
...
app.post('/forgotpassword/sendotp', async function (req, res) {
    try {
...
app.post('/forgotpassword/updatepassword', async function (req, res) {
    try {
        // Code to update user's password after verifying OTP
